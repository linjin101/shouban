...
echo $current_date : $current_epoch_seconds
echo $(date +%Y-%m-%d) $start_time : $start_epoch_seconds
echo $(date +%Y-%m-%d) $end_time : $end_epoch_seconds
echo $weekday
